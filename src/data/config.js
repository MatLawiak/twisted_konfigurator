...
export const TEMPLATE_EXAMPLES = [
  {
    ...
    style: 'minimalizm',
    bgColor: 'linear-gradient(135deg, #f8f9fa 0%, #dee2e6 100%)',
    emoji: '🏛️',
    previewUrl: '#',
  },
  {
  ...
  },
  {
    id: 'verde',
    name: 'Verde Park',
    desc: 'Styl architektoniczny',
    style: 'architektoniczny',
    bgColor: 'linear-gradient(135deg, #d0e8ff 0%, #6ea8d0 100%)',
    emoji: '🌿',
    previewUrl: '#',
  },
  {
    ...
    desc: 'Sprzedażowy',
    style: 'sprzedazowy',
    bgColor: 'linear-gradient(135deg, #fff3cd 0%, #f0a500 100%)',
    emoji: '🏙️',
    previewUrl: '#',
  },
];
